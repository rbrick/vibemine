...
public record VibedPluginSchema(String name, String description, String globals, int version, List<String> imports, Map<String, String> exports, Map<String, String> pluginEvents, List<Command> commands, List<Event> events) {
}
